...
<table align='center'>
	...
	<p><i>Halaman ini khusus untuk Anggota PSM "Gita Savana"</i></p>
	<p>Ketentuan:</p>
	<p>Username -> nama Anda</p>
	<p>Password -> Nomor Anggota(Sesuai KTA yang berlaku)</p>
	<p>Jika belum terdaftar hubungi Admin :)</p>
	
	</div> 
	<div id="menu_home_login">
		<form method='post' action='log in.php?op=in'>
			<table align='center'>
				<tr>
